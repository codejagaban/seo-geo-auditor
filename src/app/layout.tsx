...
export const metadata: Metadata = {
  title: "SEO + GEO Auditor — Audit websites for AI search visibility",
  description:
    "Audit any URL against the SEO + GEO publication standard: retrievability, structured data, citability, trust, and content depth.",
};
